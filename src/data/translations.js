...
export const translations = {
  en: {
    ...
    tagline: 'From A to Z – We Create Your Event',
    ...
    servicesSubtitle: 'Comprehensive event production services tailored to bring your vision to life with cutting-edge technology and professional expertise.',
    
    // Service Items
    audioSolutions: 'Audio Solutions',
    ...
    followUs: 'Follow Us',
    stayUpdated: 'Stay updated with our latest projects and behind-the-scenes content.',
  ...
  ar: {
    ...
    servicesSubtitle: 'خدمات إنتاج الفعاليات الشاملة المصممة خصيصاً لتحقيق رؤيتك بالتكنولوجيا المتطورة والخبرة المهنية.',
    ...
    followUs: 'تابعنا',
    stayUpdated: 'ابق على اطلاع بأحدث مشاريعنا ومحتوى ما وراء الكواليس.',
