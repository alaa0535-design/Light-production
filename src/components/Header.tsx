      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16" dir={isRTL ? 'rtl' : 'ltr'}>
          <div className="flex items-center space-x-2 rtl:space-x-reverse min-w-0">
            <Link to="/" className="flex items-center space-x-2 rtl:space-x-reverse min-w-0">
            <img 
          ...
          <div className="hidden md:flex items-center space-x-6 rtl:space-x-reverse">
            <nav className="flex space-x-8 rtl:space-x-reverse">
              <Link to="/" className="text-white hover:text-cyan-300 transition-colors duration-300">{t('home')}</Link>
              {isHomePage && (
                <>
              ...
              <Link to="/projects" className="text-white hover:text-cyan-300 transition-colors duration-300">{t('projects')}</Link>
              {isHomePage && (
